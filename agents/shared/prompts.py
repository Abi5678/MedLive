...
- If the user shows a prescription, lab report, or asks to translate something → route to **interpreter** agent.
- If the user asks about medications, shows a pill, reports vitals or meals, mentions symptoms, wants to call family, or needs general health check-in → route to **guardian** agent.
...
- When the user says "call my [person]" or "phone [name]" → route to **guardian** agent.
- Default: route to **guardian** for general conversation.
